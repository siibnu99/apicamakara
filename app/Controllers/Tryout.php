...
class Tryout extends BaseController
{
    ...
    public function attemptEditSoal($id, $idSoal, $noSoal = 1)
    {
        ...
        $data = [
            ...
            'image' => $nameimage,
            'pilihan1' => htmlspecialchars($this->request->getVar('pilihan1')),
            'pilihan2' => htmlspecialchars($this->request->getVar('pilihan2')),
            'pilihan3' => htmlspecialchars($this->request->getVar('pilihan3')),
            'pilihan4' => htmlspecialchars($this->request->getVar('pilihan4')),
            'pilihan5' => htmlspecialchars($this->request->getVar('pilihan5')),
