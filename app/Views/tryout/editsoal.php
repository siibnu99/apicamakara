    ...
    <div class="col-lg-8 col-md-12">
        <form enctype="multipart/form-data" method="POST">
            ...
            <div class="ml-2 col-sm-6">
                <?php
                if ($soalt['image']) : ?>
                    <img src="<?= base_url() . '/assets/image/soalTryout/' . $soalt['image']   ?>" id="preview" class="img-thumbnail" alt="">
                <?php else : ?>
            ...
            <div class="form-group">
                ...
                <?php foreach (abjad() as $key => $value) : ?>
                    <div class=" border border-dark my-2 p-2 rounded-sm">
                        ...
                        <div class="ml-2 col-sm-6">
                            <?php
                            if ($soalt['imagepilihan' . $value[0]]) :  ?>

                                <img src="<?= base_url() . '/assets/image/soalTryout/' . $soalt['imagepilihan' . $value[0]]   ?>" id="preview<?= $value[0] ?>" class="img-thumbnail" alt="">
                            <?php else : ?>
            ...
            <div class="ml-2 col-sm-6">
                ...
                if (isset($soalt['imagepembahasan'])) : ?>
                    <img src="<?= base_url() . '/assets/image/soalTryout/' . $soalt['imagepembahasan']   ?>" id="previewpembahasan" class="img-thumbnail" alt="">
                <?php else : ?>
                    <img src="https://placehold.it/80x80" id="previewpembahasan" class="img-thumbnail" alt="">
                <?php endif
                ?>
            </div>
            <div class="form-group">
